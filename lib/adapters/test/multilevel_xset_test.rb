...
class MultilevelXsetTest < Test::Unit::TestCase
  ...
  def test_group_by_keep_structure
    ...
    expected_extension = {
      Entity.new("_:o1") => {
        Relation.new("_:r1", true) =>{
          Literal.new(2005) => {
            Relation.new("_:year", true) => {Entity.new("_:p1")=>{}}
          }
        }
      },
      Entity.new("_:o2") => {
        Relation.new("_:r1", true) => {
          Literal.new(2005) => {
            Relation.new("_:year", true) => {Entity.new("_:p1")=>{},Entity.new("_:p2")=>{}}
          }
        }
      },
      Entity.new("_:o3") => {
        Relation.new("_:r1", true) => {
          Literal.new(2010) => {
            Relation.new("_:year", true) => {Entity.new("_:p3")=>{}}
          }          
        }
      },
    }
