...
class EndpointExplorationTest < Test::Unit::TestCase
  ...
  def test_image
    test_set = Xset.new do |s|
      s.extension = { 
        Entity.new("_:p1") => Set.new([Entity.new("_:o1"), Entity.new("_:o2")]),
        Entity.new("_:p2") => Set.new([Entity.new("_:o2")]),
        Entity.new("_:p3") => Set.new([Entity.new("_:o3")])
      }     
    end
  ...
  def test_restricted_image
    ...
    assert_equal expected_restricted_image_p1, test_set.each_image([Entity.new("_:p1")])
    assert_equal expected_restricted_image_p2, test_set.each_image([Entity.new("_:p2")])
    assert_equal expected_restricted_image_p3, test_set.each_image([Entity.new("_:p3")])    
  end
  ...
  def test_restricted_domain
    ...
    assert_equal expected_restricted_domain_o1, test_set.each_domain([Entity.new("_:o1")])
    assert_equal expected_restricted_domain_o2, test_set.each_domain([Entity.new("_:o2")])
    assert_equal expected_restricted_domain_o3, test_set.each_domain([Entity.new("_:o3")])
  end
  ...
  def test_pivot_backward
    ...
    expected_extension = { 
      Entity.new("_:o1") => Set.new([Entity.new("_:p1")]),
      Entity.new("_:o2") => Set.new([Entity.new("_:p1"), Entity.new("_:p2")])
    }
  ...
  def test_pivot_refine
    ...
    expected_extension = { 
      Entity.new("_:p1") => Set.new([Entity.new("_:o2")]),
      Entity.new("_:p2") => Set.new([Entity.new("_:o2")]) 
    }   
  ...
  def test_group_by
    ...
    expected_set = Xset.new do |s|
      s.extension = {
        Entity.new("_:o1") => Set.new([Entity.new("_:p1")]),
        Entity.new("_:o2") => Set.new([Entity.new("_:p1"), Entity.new("_:p2")]),
        Entity.new("_:o3") => Set.new([Entity.new("_:p3")]),
      }
    end
  ...
  def test_local_path
    target_set = Xset.new do |s|
      s.extension[Entity.new("_:t1")]= Set.new([Entity.new("_:u1")])
      s.extension[Entity.new("_:t2")]= Set.new([Entity.new("_:u2")])
      s.extension[Entity.new("_:t3")]= Set.new([Entity.new("_:u3")])
      s.extension[Entity.new("_:t4")]= Set.new([Entity.new("_:u4")])
      s.id = "target set"
    end
    
    mid_set_1 = Xset.new do |s|
      s.extension[Entity.new("_:i1")]= Set.new([Entity.new("_:t1")])
      s.extension[Entity.new("_:i2")]= Set.new([Entity.new("_:t2")])
      s.extension[Entity.new("_:i3")]= Set.new([Entity.new("_:t1"), Entity.new("_:t3")])
      s.extension[Entity.new("_:i4")]= Set.new([Entity.new("_:t1"), Entity.new("_:t4")])
    ...
    local_path = origin_set.local_path(target_set)
    expected_extension = {
     Entity.new("_:i1") => {Entity.new("_:t1") => Set.new([Entity.new("_:u1")])},
     Entity.new("_:i2") => {Entity.new("_:t2") => Set.new([Entity.new("_:u2")])},
     Entity.new("_:i3") => {
        Entity.new("_:t1") => Set.new([Entity.new("_:u1")]),
        Entity.new("_:t3") => Set.new([Entity.new("_:u3")])
      },
      Entity.new("_:i4") => {
        Entity.new("_:t1") => Set.new([Entity.new("_:u1")]),
        Entity.new("_:t4") => Set.new([Entity.new("_:u4")])
      },
    }
  ...
  def test_domain_path_set
    ...
    expexted_domain1 = Set.new([Entity.new("_:i1"), Entity.new("_:i4"), Entity.new("_:i3")])
    assert_equal expexted_domain1, test_set.each_domain([Entity.new("_:u1")])
    
    expected_domain2 = Set.new([Entity.new("_:i2")])
    assert_equal expected_domain2, test_set.each_domain([Entity.new("_:u2")])
  end
  
  def test_image_path_set
    test_set = Xset.new do |s|
      s.extension = {
       Entity.new("_:i1") => {Entity.new("_:t1") => Set.new([Entity.new("_:u1")])},
       Entity.new("_:i2") => {Entity.new("_:t2") => Set.new([Entity.new("_:u2")])},
    ...
    expected_image1 = Set.new([Entity.new("_:u1"),Entity.new("_:u3")])
    assert_equal expected_image1, test_set.each_image([Entity.new("_:i3")])
    
    expected_image2 = Set.new([Entity.new("_:u1"), Entity.new("_:u2")])
    assert_equal expected_image2, test_set.each_image([Entity.new("_:i1"), Entity.new("_:i2")])
  end
  ...
  def test_merge
    ...
    expected_extension = {
     "_:i1"=>{Entity.new("_:i1") => Set.new([Entity.new("_:t1")])},
     "_:i2"=>{Entity.new("_:i2") => Set.new([Entity.new("_:t2")])},
     "_:i3"=>{Entity.new("_:i3") => Set.new([Entity.new("_:t1"), Entity.new("_:t3")])},
     "_:i4"=>{Entity.new("_:i4") => Set.new([Entity.new("_:t1"), Entity.new("_:t4")])}
    }
