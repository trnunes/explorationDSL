...
#         Relation.new("_:publicationYear") => Set.new([Xpair::Literal.new(2000)]),
...
#     assert_equal Set.new([Relation.new("_:publicationYear")]), set.get_item(Xpair::Literal.new(2000)).all_parents
#   end
#
...
#         Entity.new("_:i3")=>{Relation.new("_:publicationYear") => Set.new([Xpair::Literal.new(2000)])},
...
#     assert_equal Set.new([Entity.new("_:i3"),Relation.new("_:publicationYear")]), set.get_item(Xpair::Literal.new(2000)).all_parents
#   end
#
...
#     assert_equal h3, set.get_item(Xpair::Literal.new(2000)).parents_hash
#   end
#   # def test_find_path
#   #
