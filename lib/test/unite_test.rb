...
class Xplain::UniteTest < XplainUnitTest
  ...
  def test_unite_2_height
    ...
    expected_p3 = Xplain::Node.new(Xplain::Entity.new("_:p3"))
    expected_p1.children = [Xplain::Node.new(Xplain::Entity.new("_:p1.1")), Xplain::Node.new(Xplain::Entity.new("_:p1.2")), Xplain::Node.new(Xplain::Entity.new("_:p1.3"))]
    expected_p2.children = [Xplain::Node.new(Xplain::Entity.new("_:p2.1")), Xplain::Node.new(Xplain::Entity.new("_:p2.2")), Xplain::Node.new(Xplain::Entity.new("_:p2.3"))]
    expected_p3.children = [Xplain::Node.new(Xplain::Entity.new("_:p3.1"))]
